...
import com.sesac.ai.backend.dto.request.RagChatRequest;
import com.sesac.ai.backend.dto.response.ChatResponse;
import com.sesac.ai.backend.dto.response.RagIngestResponse;
import com.sesac.ai.backend.service.ChatLogService;
import com.sesac.ai.backend.service.PythonRagClient;
...
public class RagController {
    ...
    public ChatResponse chat(
        ...
        ChatResponse response = ragClient.chat(req.question(), authorization).block();
        if (response == null) {
    ...
    public RagIngestResponse ingest(
        ...
        RagIngestResponse response = ragClient.ingest(
                file.getBytes(),
